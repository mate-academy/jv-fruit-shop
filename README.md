...
**Hint: Think about creating some FruitTransaction core.basesyntex.model to store info from file line for more convenient data processing 
...
Also, here is an example of what the `core.basesyntex.main` method may look like:
```java
public class Main {
    public static void core.basesyntex.main(String[] arg) {
...
All services should be invoked from the core.basesyntex.main() method. In each core.basesyntex.service, you should have a method that returns a specific type of data and passes this data to the method of the next core.basesyntex.service. In this way, your services will be independent of each other and your solution will adhere to SOLID principles. Moreover, such methods are easier to test. Think about what types of data the methods in each of the services should return.
...
2. Incorrect data in the input file, for example, quantity less than zero or incorrect core.basesyntex.strategy
3. Null parameters

# Fruit shop
Let's imagine that we have a fruitE store. Every day in the store there are a number of activities, 
...
```text
    ...
    p - purchase, means someone has bought some fruitE
...
#### [Try to avoid these common mistakes while solving task](https://mate-academy.github.io/jv-program-common-mistakes/java-core/solid/fruitE-shop)

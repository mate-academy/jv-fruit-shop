...
1. Balance. core.basesyntax.Fruit balance at the beginning of the work shift. The following line in the file will look like:
...
We are expecting to see how many fruits are available today after the work shift in your core.basesyntax.Fruit store. 
```text
    fruit,quantity
    banana,152
    apple,90
```
The line above means you have 152 bananas, and 90 apples in your core.basesyntax.Fruit store after the work shift.

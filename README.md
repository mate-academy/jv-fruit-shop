...
**Hint: Think about creating some FruitTransaction core.basesyntax.db.model to store info from file line for more convenient data processing 
...
All services should be invoked from the main() method. In each core.basesyntax.db.service, you should have a method that returns a specific type of data and passes this data to the method of the next core.basesyntax.db.service. In this way, your services will be independent of each other and your solution will adhere to SOLID principles. Moreover, such methods are easier to test. Think about what types of data the methods in each of the services should return.
...
2. Incorrect data in the input file, for example, quantity less than zero or incorrect core.basesyntax.db.strategy
3. Null parameters

...
```text
    b - balance, the remnants of products at the beginning of the working day
    s - supply, means you are receiving new products from suppliers
    p - purchase, means someone has bought some product
    r - return, means someone who has bought the products now returns them back
```
...
1. Supply. You are accepting new products from suppliers. The following line in the file will look like:
    
    ```text
       s,banana,100     
    ```
   The line above means you receive 100 bananas.
1. Purchase. Buyers can visit your shop and buy some products. In this case, you will have the following line in the file:
    
    ```text
       p,banana,13  
    ```
   The line above means someone has bought 13 bananas.
1. Return. Buyers can return you some products. In this case, you will have the following line in the file:
...
We are expecting to see how many products are available today after the work shift in your Fruit store. 
```text
    product,quantity
    banana,152
    apple,90

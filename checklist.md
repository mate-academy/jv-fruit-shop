...
We shouldn't have core.basesyntax.strategy.StrategyImpl and call its methods in CsvFileReaderService, or we shouldn't have CsvFileWriterService and call its methods in the core.basesyntax.strategy.StrategyImpl class.
...
- `core.basesyntax.strategy` for holding handlers for different operations (you are expected to apply core.basesyntax.strategy.StrategyImpl pattern)
...
#### Avoid using switch-cases and if-else constructions. It is recommended to use the core.basesyntax.strategy.StrategyImpl pattern instead. 

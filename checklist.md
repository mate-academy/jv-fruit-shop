...
- `test.strategy` for holding handlers for different operations (you are expected to apply Strategy pattern)
...
In the `main()` method you can pass the test.strategy map into the service that chooses the correct test.strategy for each operation.

- Example:  
    ```java
    public static void main(String[] args){
        // create and fill the test.strategy map

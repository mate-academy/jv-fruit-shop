...
In the `main()` method you can pass the core.basesyntax.strategy map into the service that chooses the correct core.basesyntax.strategy for each operation.

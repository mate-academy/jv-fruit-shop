...
In the `main()` method you can pass the strategy map into the service that chooses the correct strategy for each operationHandler.
...
#### Handling Purchase operationHandler.

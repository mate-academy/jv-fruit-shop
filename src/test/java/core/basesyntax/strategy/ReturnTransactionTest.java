...
public class ReturnTransactionTest {
    ...
    public void apply_correctWork() {
        ...
        int actualQuantity = fruits.get(new FruitBatch(FRUIT_TYPE, EXPIRY_DATE_ONE));

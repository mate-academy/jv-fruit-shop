...
public class ReportServiceImpl implements ReportService{
    ...
    public void generateReport() {
        String filePath = "src" +  File.separator + "main" + File.separator + "java" + File.separator + "core" + File.separator + "basesyntax" + File.separator + "files" + File.separator + "report.csv";

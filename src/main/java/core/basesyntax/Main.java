...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        operationStrategyMap.put(FruitTransaction.Operation.BALANCE, new BalanceOperationStrategy());
        operationStrategyMap.put(FruitTransaction.Operation.PURCHASE, new PurchaseOperationStrategy());
        operationStrategyMap.put(FruitTransaction.Operation.RETURN, new ReturnOperationStrategy());
        operationStrategyMap.put(FruitTransaction.Operation.SUPPLY, new SupplyOperationStrategy());
        List<String> dataLines = new DataReaderServiceImpl().readFile(INPUT_PATH);
        List<FruitTransaction> fruitTransactionsList = new DataParserServiceImpl().getFruitsToList(dataLines);

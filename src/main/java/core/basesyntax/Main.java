...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        TransactionProcessor transactionProcessor = new TransactionProcessorImpl(new OperationStrategyImpl());
        //1 Read data from CSV file
        List<String> stringsFromFile = new FileReaderCsvImpl().readFromFile(BALANCE_FILE_NAME);
        List<Transaction> transactionsFromFile = new TransitionConvertorImpl().convert(stringsFromFile);

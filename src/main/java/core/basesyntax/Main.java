...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        FruitsService fruitsService = new FruitsServiceImpl(operationStrategy);

        Map<String, Integer> processTransactions =
                fruitsService.processTransactions(fruitTransactions);

        String reportData = shopService.getReportData(processTransactions);

...
public class Main {
    private static final String INPUT_FILE = "src/main/resources/fruits_info.csv";
    ...
    public static void main(String[] args) {
        ...
        for (String raw : lines.subList(START_INDEX, lines.size())) {
        ...
        writerService.writeToFile(OUTPUT_FILE, finalReport);
    }
}

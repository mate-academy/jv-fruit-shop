...
public class Main {
    private static final String FILE_TO_READ = "src/main/filesResourse/reportToRead.csv";
    private static final String FILE_TO_WRITE = "src/main/filesResourse/finalReport.csv";

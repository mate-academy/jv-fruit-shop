...
import core.basesyntax.service.data.DataToOperationFormatter;
import core.basesyntax.service.data.DataToOperationFormatterImpl;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        DataToOperationFormatter dataToOperationFormatter = new DataToOperationFormatterImpl();
        ...
        dataToOperationFormatter.formatData(dataFromFile);

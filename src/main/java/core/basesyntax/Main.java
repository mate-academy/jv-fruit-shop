...
public class Main {
    public static void main(String[] args) {
        final String INPUT_FILE_PASS = "src/main/resources/FileWithInputData.csv";
        final String NEW_FILE_PASS = "src/main/resources/FileWithRestOfFruits.csv";
        Reader reader = new ReaderImpl();
        TransactionConverter convertFileToList = new TransactionConverterImpl();
        TransactionService transactionService = new TransactionServiceImpl();
        ReportService reportService = new ReportServiceImpl();
        Writer writer = new WriterImpl();
        List<String> data = reader.read(INPUT_FILE_PASS);
        ...
        writer.write(report,NEW_FILE_PASS);
    }
}

...
import core.basesyntax.service.impl.CsvTransactionReaderServiceImpl;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        TransactionReaderService transactionReaderService = new CsvTransactionReaderServiceImpl();
        List<Transaction> transactions = transactionReaderService.readFromFile(INPUT);

...
public class Main {
    private static final String PATH_TO_READ = "src/main/java/resources/storeActivities.csv";
    private static final String PATH_TO_WRITE = "src/main/java/resources/report.csv";

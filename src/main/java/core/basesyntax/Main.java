...
public class Main {
    private static final String INPUT_FILE_PATH = "src/main/java/resources/InputFile.csv";
    private static final String OUTPUT_FILE_PATH = "src/main/java/resources/OutputFile.csv";

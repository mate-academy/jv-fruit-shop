...
public class Main {
    private static final String transactionsFileName = "inputData.csv";
    private static final String reportFileName = "reports.csv";
    ...
    public static void main(String[] args) throws IOException {
        ...
        fileService.writeToFile(reportFileName);
    }
}

...
public class Main {
    private static final String INPUT_DATA_FILE_PATH = "src/main/java/core/basesyntax/resources/daily_report.csv";
    private static final String REPORT_FILE_PATH = "src/main/java/core/basesyntax/resources/report.csv";

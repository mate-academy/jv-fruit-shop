...
public class App {
    private static final String INPUT_FILE_PATH = "src/main/resources" + File.separator + "input.csv";
    private static final String OUTPUT_FILE_PATH = "src/main/resources" + File.separator + "output.csv";
    ...
    public static void main(String[] args) {
        ...
        Writer<FruitResultingRow> writer = new CsvWriterImpl(OUTPUT_FILE_PATH, OUTPUT_FILE_COLUMN_NAMES);
        DbManagerImpl.createInstance(reader, writer);

        ReportGenerator reportGenerator = new ReportGeneratorImpl();
        ReportSaver reportSaver = new ReportSaverImpl();
        Map<String, Integer> reportAboutFruits = reportGenerator.generate(DbManagerImpl.getInstance().getAll());

...
public class OperationGetterIpml implements OperationGetter {
    private Map<Transaction.TransactionType, OperationHandler> proceederGetterMap;

    public OperationGetterIpml(Map<Transaction.TransactionType, OperationHandler> proceederGetterMap) {

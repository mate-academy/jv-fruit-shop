...
public class FruitShopMain {
    ...
    public static void main(String[] args) {
        ...
        TransactionsEvaluateService evaluateService = new TransactionsEvaluateServiceImpl(new ReportStrategyImpl());
        GridWriteService gridWriteService = new CsvGridWriteService(new File(REPORT_FILE_PATH));
        // Processing transactions
        List<FruitTransaction> fruitTransactions = parser.parse(gridReadService.getGrid().getRows());

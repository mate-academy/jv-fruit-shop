...
public class HelloWorld {
    ...
    public static void main(String[] args) {
        ...
        List<FruitTransaction> fruitTransactionList = dataReaderService.readDataInFile(PATH_TO_READ_FILE);
        Map<String, Integer> processedData = processorService.processOnData(fruitTransactionList, handlerMap);
